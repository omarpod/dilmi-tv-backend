...
CANDIDATE_ENDPOINTS = [
    ...
    'live',
    'current-live',
    # مسارات مرشَّحة للأخبار الرياضية (أُضيفت للتحقق الفعلي بدل التخمين
    # — هذا المزود مبني حول البث المباشر أساساً، فالاحتمال الأقوى أنه
    # لا يوفّر أخباراً إطلاقاً، لكن نتحقق بدل الافتراض)
    'football-news',
    'news',
    'sports-news',
    'football-articles',
